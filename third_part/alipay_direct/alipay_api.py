...
class Alipay_API:
    payment_type = "1"          # 支付类型
    return_url = "http://192.168.1.199:8000/return"      # 页面跳转同步通知页面路径
    notify_url = "http://192.168.1.199:8000/notify"      # 服务器异步通知页面路径
    ...
    def alipay_submit(self, out_trade_no, subject, total_fee, body, show_url):
        parameter = {
